				...
				<div class="item-slick1 item1-slick1" style="background-image: url(images/master-slide-kigurumi.png);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						...
						<div class="wrap-btn-slide1 w-size1 animated visible-false" data-appear="zoomIn">
							<!-- Button -->
							<a href="product.php?type=Kigurumi" class="flex-c-m size2 bo-rad-23 s-text2 bgwhite hov1 trans-0-4">
								Acheter
							</a>
						</div>
					</div>
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(images/master-slide-kigurumi.png);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						...
						<div class="wrap-btn-slide1 w-size1 animated visible-false" data-appear="slideInUp">
							<!-- Button -->
							<a href="product.php?type=Chausson" class="flex-c-m size2 bo-rad-23 s-text2 bgwhite hov1 trans-0-4">
								Acheter
							</a>
						</div>
					</div>
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(images/master-slide-kigurumi.png);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						...
						<div class="wrap-btn-slide1 w-size1 animated visible-false" data-appear="rotateIn">
							<!-- Button -->
							<a href="product.php?type=Bonnet" class="flex-c-m size2 bo-rad-23 s-text2 bgwhite hov1 trans-0-4">
								Acheter
							</a>
						</div>
					</div>
					...
					<div class="block2 wrap-pic-w pos-relative m-b-30">
						...
						<div class="block2-content sizefull ab-t-l flex-col-c-m">
							...
							<p class="t-center w-size4">
								Soyez informé le premier des nouvelles arrivées et des offres promotionnelles
							</p>

							<div class="w-size2 p-t-25">
								<!-- Button -->
								<a href="newsletter.php" class="flex-c-m size2 bg4 bo-rad-23 hov1 m-text3 trans-0-4">
									S'inscrire
								</a>
							</div>
						</div>
		...
		<div class="modal-dialog" role="document" data-dismiss="modal">
			...
			<div class="wrap-video-mo-01">
				...
				<div class="video-mo-01">
					<iframe src="https://www.youtube.com/embed/MlEGfGHOEMY?ecver=2" allowfullscreen allow="autoplay; encrypted-media"></iframe>
				</div>
			</div>
		</div>
	</div>
